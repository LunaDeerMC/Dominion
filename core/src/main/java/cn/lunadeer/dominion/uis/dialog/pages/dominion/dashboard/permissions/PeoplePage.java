...
/** Entry page for member and permission-group management. */
public final class PeoplePage extends AbstractDialogPage {
    private static final DialogPageLayout LAYOUT = new DialogPageLayout(336, 2, 164, 336);

    public PeoplePage(DialogMenuUi ui, DialogUiText config, DialogNavigator nav) {
        super(ui, config, nav);
    }
    ...
    public DialogSpec render(Player player, DialogMenuSession session) {
        ...
        DominionDialogPage page = new DominionDialogPage(config, "people", values, LAYOUT)
                .summary("info", values)
