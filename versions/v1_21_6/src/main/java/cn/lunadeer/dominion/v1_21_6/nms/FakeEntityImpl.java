package cn.lunadeer.dominion.v1_21_6.nms;
...
/**
 * Fake entity implementation for Minecraft 1.21.6.
 * <p>
 * Uses PositionMoveRotation-based teleport packet (introduced in 1.21.2+).
 * Same metadata indices as 1.21:
 * <pre>
 *  8: INT   - interpolation start delay
 *  9: INT   - interpolation duration
 * 10: INT   - pos/rot interpolation duration
 * 11: VEC3  - translation
 * 12: VEC3  - scale
